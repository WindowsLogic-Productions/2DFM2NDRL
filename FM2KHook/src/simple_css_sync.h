...
struct CSSMessage {
    ...
    uint8_t p1_color_button;      // P1 color button (0x00, 0x20, 0x40, 0x80, 0x100, 0x200)
    ...
    uint8_t p2_color_button;      // P2 color button (0x00, 0x20, 0x40, 0x80, 0x100, 0x200)
};
...
public:
    ...
    void UpdateLocalState(uint8_t cursor_x, uint8_t cursor_y, uint8_t confirmed, uint8_t color_button = 0);
